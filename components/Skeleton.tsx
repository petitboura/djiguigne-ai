...
// le mouvement. Identique au composant de djiguigne-frontend et
// classgpt-frontend, à garder synchronisé.
//
...
//
// `as="span"` pour les contextes inline qui ne peuvent pas contenir de div.
