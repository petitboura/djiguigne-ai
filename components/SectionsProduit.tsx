  ...
  return (
    <div className="flex flex-col items-start gap-6">
      <div className="flex w-full max-w-xs flex-col gap-3 animate-dj-fade-up">
        {(
          [
            { cle: "matieres" as const, icon: <IconLivre /> },
          ...
          <button
            ...
            className={
              ouverte === cle
                ? "flex items-center gap-3 rounded-xl border border-dj-bordure-forte bg-dj-surface-haute px-5 py-4 text-left font-display text-base font-semibold text-dj-texte transition-colors"
                : "flex items-center gap-3 rounded-xl border border-dj-bordure bg-dj-surface px-5 py-4 text-left font-display text-base font-semibold text-dj-texte transition-colors hover:border-dj-bordure-forte hover:bg-dj-surface-haute"
            }
