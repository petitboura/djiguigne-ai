  ...
  fr: {
    ...
    etablissements: {
      ...
      inscription: {
        ...
        // Étape "profil" ajoutée le 06/08 (Bourama) : après la création du
        // compte, avant d'atterrir sur l'IA -- voir choisir_role côté
        // backend. Seul le nom est obligatoire, tout le reste optionnel.
        stepProfilTitle: "Complète ton profil",
        profilNomEtablissement: "Nom de l'établissement",
        profilNomPersonne: "Nom et prénom",
        profilLogoEtablissement: "Logo ou icône (optionnel)",
        profilPhoto: "Photo (optionnel)",
        profilBio: "Bio (optionnel)",
        profilContact: "Contact (optionnel)",
        profilSiteWeb: "Site web (optionnel)",
        profilEmailContact: "Email de contact (optionnel)",
        profilMatiere: "Matière (optionnel)",
        profilSubmitButton: "Terminer",
        profilSubmitButtonLoading: "Enregistrement…",
      },
    },
  },
  en: {
    ...
    etablissements: {
      ...
      inscription: {
        ...
        stepProfilTitle: "Complete your profile",
        profilNomEtablissement: "Institution name",
        profilNomPersonne: "Full name",
        profilLogoEtablissement: "Logo or icon (optional)",
        profilPhoto: "Photo (optional)",
        profilBio: "Bio (optional)",
        profilContact: "Contact (optional)",
        profilSiteWeb: "Website (optional)",
        profilEmailContact: "Contact email (optional)",
        profilMatiere: "Subject (optional)",
        profilSubmitButton: "Finish",
        profilSubmitButtonLoading: "Saving…",
      },
    },
  },
} as const;
