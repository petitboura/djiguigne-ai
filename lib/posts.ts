...
const posts: Record<Locale, Post[]> = {
  fr: [
    ...
    {
      slug: "comment-choisir-une-ia-specialisee",
      title: "Comment bien choisir une IA spécialisée pour son besoin",
      description:
        "Domaine précis, informations à jour, langue adaptée : trois choses simples à vérifier pour trouver l'IA spécialisée qui correspond vraiment à un besoin.",
      date: "2026-08-02",
      body: "Avec de plus en plus d'IA spécialisées disponibles, la question n'est plus \"est-ce qu'il existe une IA pour ça\" mais \"laquelle correspond vraiment à mon besoin précis\". Voici trois choses simples à regarder.\\n\\nD'abord, le niveau de précision du domaine. Une IA dédiée à une matière précise, un métier précis ou une filière précise connaît généralement mieux le sujet qu'une IA rangée dans une grande catégorie vague comme \\\"éducation\\\" ou \\\"commerce\\\". Plus le domaine est ciblé, plus les réponses ont de chances d'être pertinentes.\\n\\nEnsuite, il vaut la peine de se demander si les informations de l'IA sont à jour. Certaines IA spécialisées s'appuient sur des documents régulièrement mis à jour (un programme de cours, un catalogue produit...), ce qui leur permet de donner des réponses plus fiables qu'une IA qui ne connaît que ce qu'elle a appris une fois pour toutes, sans plus jamais être actualisée.\\n\\nEnfin, la langue et le ton comptent. Une IA pensée pour une langue précise (une langue africaine par exemple) ou habituée au vocabulaire d'un métier donné répondra de façon plus naturelle qu'une IA généraliste qui plaque un ton générique sur un sujet spécifique.\\n\\nSur Djiguignè AI, le catalogue est justement organisé par matière, métier, filière et langue, pour aider à repérer directement l'IA la mieux adaptée à un besoin, plutôt que de tester plusieurs assistants au hasard.",
    },
  ],
  en: [
    {
    ...
    {
      slug: "how-to-choose-a-specialized-ai",
      title: "How to choose the right specialized AI for your need",
      description:
        "A precise domain, up-to-date information, the right language: three simple things to check to find the specialized AI that actually fits a need.",
      date: "2026-08-02",
      body: "With more and more specialized AIs available, the question isn't \"is there an AI for this\" anymore, but \"which one actually fits my precise need\". Here are three simple things to look at.\n\nFirst, how precise the domain is. An AI dedicated to a specific subject, profession, or track usually knows the topic better than one filed under a broad category like \"education\" or \"commerce\". The more focused the domain, the more likely the answers are relevant.\n\nSecond, it's worth checking whether the AI's information is kept current. Some specialized AIs rely on regularly updated material (a course syllabus, a product catalog...), which lets them give more reliable answers than an AI that only knows what it learned once, with no updates since.\n\nFinally, language and tone matter. An AI built for a specific language (an African language, for instance) or used to a given profession's vocabulary will feel more natural than a general-purpose AI applying a generic tone to a specific topic.\n\nOn Djiguignè AI, the catalog is organized by subject, profession, track, and language, precisely to help spot the AI best suited to a need, rather than testing several assistants at random.",
    },
  ],
};
